...
import { RefDomT, RefTmptT } from '@/common/types/etc';
...
export class CsrNoticeWrapper implements AfterViewInit {
  ...
  // ? projected
  @ContentChild('header', { read: TemplateRef }) headerTpl?: RefTmptT;
  @ContentChild('footer', { read: TemplateRef }) footerTpl?: RefTmptT;
